...
Define installation of SDR from a pinned public repository revision as the supported acquisition
route, the canonical repository identity that installation instructions must name, and the evidence
that an installed console script completes a lifecycle.
